...
jQuery(document).ready(function ($) {
    ...
    $(".mumu").mouseover(function () {
       $(".mumu").fadeTo("300", 0.3);
       msgs = ["收藏奇迹秀，我就跟你玩~", "秀宝可远观不可亵玩！", "我都隐身啦，你还摸！", "别动手动脚的，把手拿开！！", "再不把手拿开小心我横竖竖你！！", "老大，他摸我，呜呜呜呜~~~", "你把手拿开我就出来！", "你关注「奇迹秀」公众号了吗？不要摸我啦！", ];
...
jQuery(document).ready(function ($) {
    ...
    window.setInterval(function () {
        msgs = ["只有您常常来看我，秀宝才有动力分享更多哦！", "好无聊哦，你都不陪我玩~", "…@……!………", "^%#&*!@*(&#)(!)(", "我是老大的小小助理哦~_~", "我可爱吧！嘻嘻!~^_^!~~","谁淫荡呀?~谁淫荡?，你淫荡呀!~~你淫荡！~~","从前有座山，山上有座庙，庙里有个老和尚给小和尚讲故事，讲：“从前有座……”"];
        var i = Math.floor(Math.random() * msgs.length);
...
jQuery(document).ready(function ($) {
    window.setInterval(function () {
        msgs = ["只有您常常来看我，秀宝才有动力分享更多哦！", "乾坤大挪移！", "我飘过来了！~", "我飘过去了", "我得意地飘！~飘！~"];
        var i = Math.floor(Math.random() * msgs.length);
...
tpwidget("init", {
    ...
    "theme": "white",
    "uid": "U09ECA4A74",
    "hash": "6ebf45841fb2fde092bf7cfdcb73e796"
});
tpwidget("show");
